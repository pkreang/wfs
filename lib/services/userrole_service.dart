...
class UserRoleService {
  Future<List<UserRole>> GetList(String accessToken) async {
    ...
    if (response.statusCode == 200) {
      ...
      final List<dynamic> userRoleListJson = data['user_roles'];
      return userRoleListJson.map((json) => UserRole.fromJson(json)).toList();
    } else {
      throw Exception(
